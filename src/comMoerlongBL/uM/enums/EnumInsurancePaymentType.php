...
class EnumInsurancePaymentType
{
	...
	public static function toJSON(){
		return '{"name":"EnumInsurancePaymentType","fullName":"App\\Http\\Modules\\UMComponent\\GeneratedCodes\\Enum\\EnumInsurancePaymentType","displayName":"缴费方式","description":"缴费方式","items": [{"value":"1","name":"byYear","displayName":"按年","description":"按年"},{"value":"2","name":"byMonth","displayName":"按月","description":"按月"},{"value":"4","name":"bySeason","displayName":"按季","description":"按季"},{"value":"8","name":"onetime","displayName":"趸交","description":"趸交"}]}';
	}
}
