...
{
	const description=array('0'=>'未定义','1'=>'协议未分配后台超时关闭','2'=>'查验点超时关闭','4'=>'进件未完成超时关闭','8'=>'评估未完成超时关闭','16'=>'放款未完成超时关闭','32'=>'放款后，新规划子订单未完成进件关闭','64'=>'重分配超时关闭','128'=>'因协议取消签单关闭','256'=>'因订单无效拒单关闭','512'=>'因订单取消签单关闭','1024'=>'激活再超时关闭');
